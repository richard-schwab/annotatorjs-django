/*
 ** Annotator v2.0.0-alpha.2-229eddc
        ...
        25: [
            function(require, module, exports) {
                ...
                function banner(message, severity) {
                    ...
                    $(element).addClass(bannerClasses.show).addClass(bannerClasses[severity]).html(util.escapeHtml(message || "")).appendTo(util.getGlobal().document.body);
